...
function CopyBtn({ id }) {
  ...
  const collectionUrl = `${baseUrl}/${id}`; // Adjust according to your logic for getting the collection URL
  ...
  return (
    <button
      ...
      className="p-2 bg-slate-700 text-xs h-fit w-fits text-white rounded"
    >
      {copied ? (
        <svg
